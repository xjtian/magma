...
function SubscriberConfigTrafficPolicy({
  ...
  return (
    <List component={Paper}>
      <ListItem button onClick={() => handleCollapse(0)}>
        <TextField
          fullWidth={true}
      ...
      <Divider />
      <Collapse key="0" in={open[0]} timeout="auto" unmountOnExit>
        <ListItem>
          <TextField
            fullWidth={true}
      ...
      <Divider />
      <Collapse key="1" in={open[1]} timeout="auto" unmountOnExit>
        <ListItem>
          <TextField
            fullWidth={true}
      ...
      <Collapse key="2" in={open[2]} timeout="auto" unmountOnExit>
        <ListItem>
          <TextField
            fullWidth={true}
